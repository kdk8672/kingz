...
<div class="bradcam_area breadcam_bg_2"><h1 style="color:white;">MY PAGE</h1></div>
<body>
    <div class="container">
			...
			<div class="card-content">
				...
				<c:forEach var="reserve" items="${reserve }">
					<div class="mb-4 border rounded-lg p-4 flex justify-between">
						...
						<div class="flex">
							<p class="w-24 h-24 object-cover rounded mr-4">
								<img src="img/rooms/${reserve.imageUrl }"
						...
						<div class="text-right">
							<p style="font-weight: bolder">숙박 일수: ${reserve.night }박
								${reserve.night + 1 }일</p>
							<c:choose>
								<c:when test="${reserve.breakfast eq 1 }">
									<p style="font-weight: bold">총 결제금액: ${reserve.roomPrice + (reserve.headCount * 10000) - reserve.paymentPoint }원</p>
							...
							<div class="accordion">
								...
								<div class="accordion-content">
									...
									<button
										onclick="location.href='reserveDelete.do?reserveId=${reserve.reserveId}&memberId=${reserve.memberId }'">예약
										취소</button>
								</div>
							</div>
						</div>
						...
						<tbody>
							<tr>
								...
								<td><c:choose>
										...
										<c:otherwise>
											<img src="img/review/${review.imageUrl }"
				...
				<form class="space-y-4" action="modifymypage.do" method="POST"
					...
					<div class="form-group">
						<label class="form-label" for="id"
							style="font-weight: bold; color: black;">아이디</label>
						<p>${id }</p>
					</div>
					<div class="form-group">
						<label class="form-label" for="password"
							style="font-weight: bold; color: black;">비밀번호</label> <input
							id="password" name="pass" class="form-input" type="password"
							required />
					</div>
					<div class="form-group">
						<label class="form-label" for="password"
							style="font-weight: bold; color: black;">비밀번호확인</label> <input
							id="passwordCheck" name="pass" class="form-input" type="password"
							required />
					</div>
					<div class="form-group">
						<label class="form-label" for="name"
							style="font-weight: bold; color: black;">이름</label>
						<p>${logName }</p>
					</div>
					<div class="form-group">
						<label class="form-label" for="email"
							style="font-weight: bold; color: black;">이메일</label> <input
							id="email" name="email" class="form-input" type="email" />
					</div>
					<div class="form-group">
						<label class="form-label" for="phone"
							style="font-weight: bold; color: black;">전화번호</label> <input
							id="phone" name="phone" class="form-input"
							pattern="010-\d{4}-\d{4}$" />
					</div>
					<button type="submit" class="button">정보 수정</button>
				</form>
