...
function setSearchParams() {
	...
	if(roomType != null || inDate != null || outDate != null || inHeadcount != null){
		document.querySelectorAll("#checkin").forEach(value => {
			value.value = inDate;
		});
		document.querySelectorAll("#checkout").forEach(value => {
			value.value = outDate;
		});
		document.querySelectorAll("#headcount").forEach(value => {
			value.value = inHeadcount;
		});
	}
}
